...
<div id="wrapper">
	...
	<div id="content" class="xgrid">
		...
		<div id="welcome" class="x4">			
			...
			<p><strong><a href="./pages/text.jsp">欢迎回来, ${emp.empName }</a></strong><br /></p>
		...
		<div class="x6">
			...
			<h2>
				待处理的工单
				<span class="fright "><a href="./page/be_order.jsp" class="ticket closed" style="color:#fff;">更多</a></span>
			</h2>
			...
			<table class="data support_table">
				...
				<tr>
					...
					<td class="full"><a href="./page/be__auditForm.jsp" target="_blank">雨花区南门口东风巷子12号</a></td>					
					<td class="who"><a href="./page/be__auditForm.jsp" target="_blank">张三</a></td>
				</tr>
		...
		<a href="./page/error.jsp">出错演示页</a> |
		<a href="./page/success.jsp">成功演示页</a>
