...
<div id="wrapper">
	...
	<div id="content" class="xgrid">
		...
		<div class="x12">
			...
			<p><button class="btn-icon btn-plus" onClick="location='page/sys_dept_add.jsp';"><span></span>添加部门</button></p>
			...
			<table class="data display">
					...
					<c:forEach items="${mlist }" var="m">
						<tr class="odd gradeX">
							...
							<td>${m.remark }</td>
							<td class="center">
								<button class="btn-icon btn-small btn-blue btn-star" onClick="location='seldeptid.do?id=${m.id}';"><span></span>修改</button>  
								<a href="deldept.do?id=${m.id }" rel="facebox" class="btn-icon btn-small btn-red btn-cross"><span></span>删除</a>
							</td>
						</tr>
                        </c:forEach>
						</tbody>
